...
function App() {
  ...
  const {
    cart, showToast, toastMessage, setShowToast,
    addToCart, removeFromCart, increaseQuantity, decreaseQuantity,
    clearCart, open, setOpen, isEmpty, total, filteredProducts, handleFilter,
    showMenu, setShowMenu, menuRef, darkMode, setDarkMode
  } = useCart();
